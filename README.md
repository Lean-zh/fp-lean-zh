...
To build the book, change to the "book" directory and run "lake exe fp-lean-zh". After this, "book/out/html-multi" contains a multi-page Web version of the book.
